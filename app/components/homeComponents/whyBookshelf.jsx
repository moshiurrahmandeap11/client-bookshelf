  ...
  const features = [
    {
      ...
      description:
        "Filter by genre, price, rating, and more. Find exactly the book you're in the mood for in seconds.",
      delay: "delay-0",
    },
    {
      id: 2,
      ...
      description:
        "Add your own books, manage your collection, and keep everything organized in one beautiful place.",
      delay: "delay-100",
    },
    {
      id: 3,
      ...
      description:
        "Real ratings from real readers. Make informed decisions with community-driven insights.",
      delay: "delay-200",
    },
    {
      id: 4,
      ...
      description:
        "Your reading habits are yours alone. Login with email or Google with industry-grade security.",
      delay: "delay-0",
    },
    {
      id: 5,
      ...
      description:
        "Fully responsive on desktop, tablet, and phone. Your library goes wherever you go.",
      delay: "delay-100",
    },
    {
      id: 6,
      ...
      description:
        "Add, edit, and remove books from your collection with a clean and intuitive management panel.",
      delay: "delay-200",
    },
  ];
      ...
      <div className="relative z-10 max-w-11/12 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 lg:mb-20">
          ...
          <p className="text-base sm:text-lg text-gray-400 max-w-2xl mx-auto">
            Discover why thousands of readers trust BookShelf for their daily
            reading journey
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
          {features.map((feature) => (
            ...
            >
              ...
              {/* Icon Container */}
              <div
                className={`relative mb-5 sm:mb-6 w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-linear-to-br ${feature.iconBg} rounded-2xl flex items-center justify-center shadow-lg transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-3`}
              >
