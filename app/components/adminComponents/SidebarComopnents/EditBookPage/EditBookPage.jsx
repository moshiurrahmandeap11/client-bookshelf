  ...
  const handleGalleryChange = (e) => {
    ...
    if (validFiles.length !== files.length) {
      Swal.fire({
        icon: "error",
        title: "Error!",
        text: "Some images exceed 2MB limit",
        background: "#2A2219",
        color: "#fff",
      });
    }
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-4 pt-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="px-6 py-2 bg-linear-to-r from-amber-500 to-orange-600 text-white rounded-xl hover:from-amber-600 hover:to-orange-700 transition-all duration-300 disabled:opacity-50 flex items-center gap-2"
          >
            {submitting ? (
              <>
