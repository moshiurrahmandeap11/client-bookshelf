...
const AdminSettingsPage = () => {
  ...
  const reloadFavicon = (newFaviconUrl) => {
    ...
    newLink.rel = "icon";
    newLink.href = `${newFaviconUrl}?v=${Date.now()}`;
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {ogImagePreview ? (
                  ...
                  <label className="cursor-pointer block">
                    ...
                    <input
                      ...
                      accept="image/*"
                      onChange={(e) =>
                        handleFileChange("ogImage", e.target.files[0])
                      }
                      className="hidden"
                    />
                  </label>
        ...
        <div className="bg-white/5 rounded-2xl p-6 border border-white/10 space-y-4">
          <h2 className="text-lg font-semibold text-white flex items-center gap-2">
            <FiGlobe className="w-5 h-5" /> Site Information
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-xl text-white"
                placeholder="books, reading, ebook, library"
              />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-gray-300 text-sm mb-1 flex items-center gap-2">
                <FiMail className="w-4 h-4" /> Contact Email
              </label>
              <input
                type="email"
                name="contactEmail"
            ...
            <div>
              <label className="block text-gray-300 text-sm mb-1 flex items-center gap-2">
                <FiPhone className="w-4 h-4" /> Contact Phone
              </label>
              <input
                type="text"
                name="contactPhone"
            ...
            <div className="md:col-span-2">
              <label className="block text-gray-300 text-sm mb-1 flex items-center gap-2">
                <FiMapPin className="w-4 h-4" /> Contact Address
              </label>
              <input
                type="text"
                name="contactAddress"
        ...
        <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
          ...
          <input
            ...
            onChange={handleInputChange}
            className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-xl text-white"
            placeholder="© 2024 BookShelf. All rights reserved."
          />
        </div>
        ...
        <div className="flex justify-end gap-4">
          ...
          <button
            type="submit"
            disabled={saving}
            className="px-6 py-2 bg-gradient-to-r from-amber-500 to-orange-600 text-white rounded-xl hover:from-amber-600 hover:to-orange-700 transition-all duration-300 flex items-center gap-2"
          >
            {saving ? (
              <>
