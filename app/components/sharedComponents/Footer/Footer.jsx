...
const Footer = () => {
      ...
      try {
        ...
        if (res.data.success) {
          ...
          setSettings({
            ...
            footerText:
              data.footerText || "© 2024 BookShelf. All rights reserved.",
  ...
  const getFooterText = () => {
    ...
    return (
      settings.footerText || `© ${currentYear} BookShelf. All rights reserved.`
    );
  };
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Your digital library for discovering, organizing, and enjoying
              thousands of books from anywhere in the world.
            </p>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">{getFooterText()}</p>
